...
a3.parentElement.addEventListener('mouseover', function () {
...
a3.parentElement.addEventListener('mouseout', function () {
    a3.parentElement.style.backgroundColor = "rgb(6, 70, 206)";
    a3.style.color = "rgb(255,255,255)";
    a3.style.fontWeight = "Normal";
    img3.src = "img/monthly.png";
})
